...
patch_mix_t::patch_mix_t() {
    new_mixer_spec = mixer_033::list_specs{
        ...
        {.spacer = true},
        {.name = "bass", .props = {.gain = 0.23913038, .pan = 0, .mono = false, .mute = false}},
        {.spacer = true},
        ...
        {.name = "snare impulse send", .props = {.gain = 0.8913044, .pan = 0, .mono = false, .mute = false}},
        ...
        {.spacer = true},
        {.name = "chord bus", .props = {.gain = 0.40217388, .pan = 0, .mono = false, .mute = false}},
        {.spacer = true},
