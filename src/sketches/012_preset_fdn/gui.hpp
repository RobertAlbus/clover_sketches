    ...
    auto guiFunction = [&]() {
        if (ImGui::BeginTabBar("MyTabBar")) {
            ...
            if (ImGui::BeginTabItem("kick")) {
                ...
                // adsr("kick_amp", ranges, kick.props.amp_a, kick.props.amp_d, kick.props.amp_s,
                // kick.props.amp_r);

                // ImGui::TableNextColumn();
                // ImGui::TextUnformatted("kick_cut");
                // ranges.d_max = 20000;
                // adsr("kick_cut", ranges, kick.props.cut_a, kick.props.cut_d, kick.props.cut_s,
                // kick.props.cut_r);

                // ImGui::TableNextColumn();
                // ImGui::TextUnformatted("kick_pitch");
                // ranges.d_max = 10000;
                // adsr("kick_pitch", ranges, kick.props.pitch_a, kick.props.pitch_d, kick.props.pitch_s,
                // kick.props.pitch_r);
                // // clang-format on
