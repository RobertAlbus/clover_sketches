...
patch_mix_t::patch_mix_t() {
    new_mixer_spec = mixer_033::list_specs
...

        {
            ...
            {.name = "kick wet", .props = {.gain = 0.5543479, .pan = 0, .mono = false, .mute = false}},
            {.spacer = true},
            ...
            {.name = "chord 1 verb", .props = {.gain = 0.61956525, .pan = 0, .mono = false, .mute = false}},
            {.name = "chord 2 dry", .props = {.gain = 0.40217388, .pan = 0, .mono = false, .mute = true}},
            {.name = "chord 2 verb", .props = {.gain = 2, .pan = 0, .mono = false, .mute = true}},
    };
