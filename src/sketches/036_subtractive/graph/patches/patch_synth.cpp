...
patch_synth_t::patch_synth_t() {
    ...
    chord_props = {
        ...
        .waveforms         = {waveform_000::square, waveform_000::square, waveform_000::noise, waveform_000::noise, waveform_000::sine, waveform_000::sine},
        .pitch_a           = 10,
        .pitch_d           = 10,
        .pitch_s           = 0,
        .pitch_r           = 10,
        ...
        .cut_env_octaves   = 2,
        .res_env_octaves   = 0,
        .filter_type       = peq_filter_type::lp,
        .cut_a             = 3500,
        .cut_d             = 1000,
        .cut_s             = 0.1,
        .cut_r             = 1000,
    ...
    .waveforms = {waveform_000::square, waveform_000::square, waveform_000::saw, waveform_000::saw, waveform_000::noise, waveform_000::noise},
    .pitch_a = 10,
    .pitch_d = 10,
    .pitch_s = 0,
    .pitch_r = 10,
