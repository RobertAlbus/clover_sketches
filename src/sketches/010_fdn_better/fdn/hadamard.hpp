...
extern const std::array<float, 4> hadamard_2x2;
extern const std::array<float, 16> hadamard_4x4;
extern const std::array<float, 64> hadamard_8x8;
extern const std::array<float, 256> hadamard_16x16;
